...
export function isInsideSqlRegion(languageService: LanguageService, documentText: string, offset: number) {
...
export function getCSSVirtualContent(languageService: LanguageService, documentText: string): string {
