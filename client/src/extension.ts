...
import { getCSSVirtualContent, isInsideSqlRegion } from "./embeddedSupport";
  ...
  const clientOptions: LanguageClientOptions = {
    ...
    middleware: {
      provideCompletionItem: async (document, position, context, token, next) => {
        ...
        if (!isInsideSqlRegion(htmlLanguageService, document.getText(), document.offsetAt(position))) {
